...
import { LayoutDashboard, Stethoscope, Users, Settings, BarChart3, PlusCircle } from 'lucide-react';
...
const Sidebar: React.FC = () => {
  ...
  const menuItems = [
    ...
    { icon: Settings, label: 'Configuration Cabinet', path: '/settings' },
  ];
    ...
    <div className="w-64 bg-white border-r h-screen sticky top-0 flex flex-col no-print shadow-sm z-30">
      <div className="p-6 border-b flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[10px] text-emerald-600 font-bold uppercase tracking-widest">Intelligent Clinic</p>
        </div>
      </div>
      ...
      <nav className="flex-1 p-4 space-y-1">
        {menuItems.map((item) => {
          ...
          return (
            ...
            >
              <item.icon size={20} className={isActive ? 'text-emerald-600' : 'text-gray-400 group-hover:text-emerald-400'} />
